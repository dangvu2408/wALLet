        ...
        btn_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (money_input.getText().toString().equals("")) {
                    ...
                    addTransRevenue(Constants.BASE_URL_INSERT_TRANS_DATA, "revenue_money", type, money, datepicker, description, number, fullname);
                }
            }
        });
        ...
        StringRequest strRequest = new StringRequest(Request.Method.POST, url,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(AddRevenueActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
